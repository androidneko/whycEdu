...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabWidth = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_tab_width, 30);
        typedArray.recycle();
    }
    ...
    public void setTabAdapter(TabAdapter adapter) {
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < adapter.getCount(); i++) {
                addTab(new QTabView(mContext,mTabHeight,mTabWidth).setIcon(adapter.getIcon(i))
        ...
        if (mPagerAdapter != null) {
            ...
            if (mPagerAdapter instanceof TabAdapter) {
                ...
                for (int i = 0; i < adapterCount; i++) {
                    ...
                    addTab(new QTabView(mContext,mTabHeight,mTabWidth).setTitle(
