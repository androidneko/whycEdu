...
public class SPConsts {
    ...
    public static final String LAST_WXWEBVIEW_URL = "LAST_WXWEBVIEW_URL";
    ...
    /**岭南通订单上传*/
    public static final String LNT_QC_OCCURS = "lnt_qc_occurs";
    public static final String LNT_LOGIN_PKI = "lnt_login_pki";
    public static final String LNT_LOGIN_SERIAL = "lnt_login_serial";
    public static final String LNT_CONNECTTYPE = "lnt_connecttype";
    public static final String LNT_USERNAME = "lnt_username";
    ...
    public static final String WATCH_SEAT_IS_SUCCESS="watch_seat_is_success";
    public static final String LEVEL="level";
    public static final String LEVEL_NAME="level_name";
    public static final String LEVEL_DES="level_des";
    public static final String RUN_DISTANCE="run_distance";

    public static final String VERSION_NAME = "versionName";

    /**指令相关 */
    public static final String CONFIG_FILE_CODE = "configFileCode";
    ...
    public static boolean IS_B1601_CONNECT=false;
