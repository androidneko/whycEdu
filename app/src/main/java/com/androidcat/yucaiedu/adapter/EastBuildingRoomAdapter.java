...
public class EastBuildingRoomAdapter extends BaseAdapter {
    ...
    public EastBuildingRoomAdapter(Context context, List<Room> rooms) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = inflater.inflate(R.layout.item_room_eastbuilding, null);
